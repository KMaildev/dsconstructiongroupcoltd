...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
    ...
    <div id="jssor_1"
        style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:1200px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->

        <div data-u="slides"
            style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:1200px;overflow:hidden;">
            <div>
                <img data-u="image" data-src="{{ asset('data/slider/2.jpg') }}" />
            </div>
            ...
            <div>
                <img data-u="image" data-src="{{ asset('data/slider/3.jpg') }}" />
            </div>
