...
class ProjectsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				projects.project_description LIKE ? OR 
				projects.location LIKE ? OR 
				projects.project_area LIKE ? OR 
				projects.project_duration LIKE ? OR 
				projects.photo LIKE ? OR 
				projects.gallery LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("title","project_description","location","project_area","project_duration","photo","gallery");
			...
			$this->sanitize_array = array(
				...
				'project_description' => 'sanitize_string',
				'location' => 'sanitize_string',
				'project_area' => 'sanitize_string',
				'project_duration' => 'sanitize_string',
				'photo' => 'sanitize_string',
				'gallery' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","title","project_description","location","project_area","project_duration","photo","gallery");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'title' => 'required',
